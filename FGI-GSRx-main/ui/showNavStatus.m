...
xyz_r=wgslla2xyz(allSettings.const,allSettings.nav.trueLat,allSettings.nav.trueLong,allSettings.nav.trueHeight);

fprintf('********************Real Position********************************\n');
fprintf('* X: %6.2f  Y: %6.2f  Z: %6.2f  Fom: %4.2f   *\n',xyz_r(1),xyz_r(2),xyz_r(3),navSolution.Pos.fom); 
fprintf('* Latitude: %6.6f  Longitude: %6.6f  Height: %6.2f  Fom: %4.2f   *\n',allSettings.nav.trueLat,allSettings.nav.trueLong,allSettings.nav.trueHeight,navSolution.Pos.fom); 
fprintf('************************************************************\n');

[lat_t,long_t,height_t]=wgsxyz2lla(allSettings.const,[navSolution.Pos.xyz(1),navSolution.Pos.xyz(2),navSolution.Pos.xyz(3)]);

fprintf('********************Tracked Position********************************\n');
fprintf('* X: %6.2f  Y: %6.2f  Z: %6.2f  Fom: %4.2f   *\n',navSolution.Pos.xyz(1),navSolution.Pos.xyz(2),navSolution.Pos.xyz(3),navSolution.Pos.fom);
fprintf('* Latitude: %6.6f  Longitude: %6.6f  Height: %6.2f  Fom: %4.2f   *\n',lat_t,long_t,height_t,navSolution.Pos.fom); 
