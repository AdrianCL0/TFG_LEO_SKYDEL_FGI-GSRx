...
trackChannel.prevIR2_DLL=0;
trackChannel.codeDiscrFilt=0;
trackChannel.dllNoiseBandwidth=signalSettings.dllNoiseBandwidth;
...
trackChannel.prevIR2_FLL=[0 0 0 0];
% PLL Loop values
